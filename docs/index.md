...
features:  # 可选的
  - title: 统一管理
    details: 建立一个统一的组件库可以提高团队协作效率和降低开发成本。
  - title: 提高质量
    details: 组件库中的组件经过严格测试和验证，可以提高代码质量和用户体验。
  - title: 代码复用
    details: 组件库提供可重用的组件，可以减少重复编写代码的工作量。
  - title: 一致性体验
    details: 组件库中的组件可以提供一致的用户体验，提高用户满意度和体验。
...
.home-wrapper .banner .banner-conent .feature{
...
## 🎉更新通知
* `v1.0.0`
  - 新增组件`field`，用于切换页面的风格样式，可选`卡片`、 `线条`风格。[详情](/pages/a20ce8/#pagestyle)
